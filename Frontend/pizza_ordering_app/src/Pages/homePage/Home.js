        ...
        <div className="container-fluid" class="gradient">
           ...
           <div className="row">
            ...
            <div style={{textAlign:"center",marginTop:40}}>
                ...
                <h5><b style={{fontSize:80,color:'#5C41A8'}}>Pizza Hut</b></h5>
                    ...
                    <div className="row" style={{height:50,marginTop:30,marginRight:100}}>
                        ...
                        {/* <img src={Kalpesh} className="card-img-top" style={{ height: 250,
                               ...
                               boxShadow: "0px 4px 18px 3px rgba(0,0,0,0.38)",
                                display: "block",
                                 borderRadius: 5,}} alt="..."/> */}
                                 <div style={{marginLeft:-110,marginTop:10}}> <h5 style={{textAlign:"center"}}>SUDHANSHU RATHORE</h5></div>
                                 <div style={{marginLeft:-40,marginTop:10,marginBottom:20, color:"blue"}}> <h7 style={{textAlign:"center"}}>sudh.rathore@gmail.com</h7></div>
                        ...
                        {/* <img src={Pankaj} className="card-img-top" style={{ height: 250,
                                ...
                                display: "block",
                                 borderRadius: 5,}} alt="..."/> */}
                                 <div style={{marginLeft:-100,marginTop:10}}> <h5 style={{textAlign:"center"}}>SHIVENDRA CHAUHAN</h5></div>
                                 <div style={{marginLeft:-60,marginTop:10,marginBottom:20, color:"blue"}}> <h7 style={{textAlign:"center"}}>SHIVENDRA@gmail.com</h7></div>
                        ...
                        {/* <img src={Raviraj} className="card-img-top" style={{ height: 250,
                                ...
                                display: "block",
                                 borderRadius: 5,}} alt="..."/> */}
                                 <div style={{marginLeft:-110,marginTop:10}}> <h5 style={{textAlign:"center"}}>RASIKA KARDILE</h5></div>
                                 <div style={{marginLeft:-60,marginTop:10,marginBottom:20, color:"blue"}}> <h7 style={{textAlign:"center"}}>RASIKA@gmail.com</h7></div>
                        ...
                        {/* <img src={Omkar} className="card-img-top" style={{ height: 250,
                                ...
                                display: "block",
                                 borderRadius: 5,}} alt="..."/> */}
                                 <div style={{marginLeft:-110,marginTop:10}}> <h5 style={{textAlign:"center"}}>POOJA NEMADE</h5></div>
                                 <div style={{marginLeft:-60,marginTop:10,marginBottom:20, color:"blue"}}> <h7 style={{textAlign:"center"}}>POOJA@gmail.com</h7></div>
