...
import SHIVENDRA from "../../images/SHIVENDRA.jpg";
        ...
        >
          <div className="col">
            ...
            <div style={{ marginLeft: -110, marginTop: 10 }}>
              {" "}
              <h5 style={{ textAlign: "center" }}>SUDHANSHU RATHORE</h5>
            </div>
            <div
              style={{
                marginLeft: -40,
            ...
            >
              {" "}
              <h7 style={{ textAlign: "center" }}> sudh.rathore@gmail.com</h7>
            </div>
            <div
              style={{
                marginLeft: -40,
            ...
            >
              {" "}
              <h7 style={{ textAlign: "center" }}> +918770322141</h7>
            </div>
          </div>
          <div className="col">
            <img
            ...
            <div style={{ marginLeft: -100, marginTop: 10 }}>
              {" "}
              <h5 style={{ textAlign: "center" }}>SHIVENDRA CHAUHAN</h5>
            </div>
            <div
              style={{
                marginLeft: -60,
            ...
            >
              {" "}
              <h7 style={{ textAlign: "center" }}>shivendrachauhan001@gmail.com</h7>
            </div>
            <div
              style={{
                marginLeft: -40,
            ...
            >
              {" "}
              <h7 style={{ textAlign: "center" }}> +918006387086</h7>
            </div>
          </div>
          <div className="col">
            <img
